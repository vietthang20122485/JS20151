...
public class QuanLy extends javax.swing.JFrame {
    ...
    private void ThemTSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThemTSActionPerformed
        ThongTinSinhVien thisinh = getThiSinh();
        thisinh.ThemTS(thisinh);
        loadDataTS();
    }//GEN-LAST:event_ThemTSActionPerformed

    private void SuaTSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SuaTSActionPerformed
        if (loadTS()) {
            LuuTS.setEnabled(true);
        }
    }//GEN-LAST:event_SuaTSActionPerformed

    private void XoaTSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_XoaTSActionPerformed
        int row = tbThiSinh.getSelectedRow();
        if (row < 0) {
    ...
    }//GEN-LAST:event_XoaTSActionPerformed

    private void LuuTSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LuuTSActionPerformed
        ...
        loadDataTS();
        xoaText();
    }//GEN-LAST:event_LuuTSActionPerformed

    private void TangDanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TangDanActionPerformed
        // TODO add your handling code here:
        loadSort_KQ("ASC");
    }//GEN-LAST:event_TangDanActionPerformed

    private void GiamDanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GiamDanActionPerformed
        // TODO add your handling code here:
        loadSort_KQ("DESC");
    }//GEN-LAST:event_GiamDanActionPerformed

    private void CaoNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CaoNhatActionPerformed
        // TODO add your handling code here:
        loadMax_KQ();
    }//GEN-LAST:event_CaoNhatActionPerformed

    private void ThapNhatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ThapNhatActionPerformed
        // TODO add your handling code here:
        loadMin_KQ();
    }//GEN-LAST:event_ThapNhatActionPerformed
